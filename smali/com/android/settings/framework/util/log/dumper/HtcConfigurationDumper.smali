.class Lcom/android/settings/framework/util/log/dumper/HtcConfigurationDumper;
.super Lcom/android/settings/framework/util/log/dumper/HtcAbsDumper;
.source "HtcConfigurationDumper.java"
...
.method static constructor <clinit>()V
    ...
    const-class v1, Lcom/android/settings/framework/util/log/dumper/HtcConfigurationDumper;
    ...
    sput-object v0, Lcom/android/settings/framework/util/log/dumper/HtcConfigurationDumper;->TAG:Ljava/lang/String;
...
.method public static getDescriptionOfFontScale(I)Ljava/lang/String;
    ...
    const-string v1, "Unknown fontSize: "
...
.method public static getDescriptionOfHasNavBar(I)Ljava/lang/String;
    ...
    const-string v1, "Unknown hasNavBar: "
...
.method public static getDescriptionOfKeyboard(I)Ljava/lang/String;
    ...
    const-string v1, "Unknown keyboard: "
...
.method public static getDescriptionOfKeyboardHidden(I)Ljava/lang/String;
    ...
    const-string v1, "Unknown keyboardHidden: "
...
.method public static getDescriptionOfTouchscreen(I)Ljava/lang/String;
    ...
    const-string v1, "Unknown touchscreen: "
...
.method public appendIntrinsicInfo(Ljava/lang/StringBuilder;Ljava/lang/String;Landroid/content/res/Configuration;)V
    ...
    iget v1, p3, Landroid/content/res/Configuration;->fontScale:F
    ...
    iget v2, p3, Landroid/content/res/Configuration;->fontsize:I
    ...
    iget v2, p3, Landroid/content/res/Configuration;->navigation:I

    invoke-static {v2}, Lcom/android/settings/framework/util/log/dumper/HtcConfigurationDumper;->getDescriptionOfFontScale(I)Ljava/lang/String;
    ...
    const-string v2, "          hasNavBar: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget v2, p3, Landroid/content/res/Configuration;->hasNavBar:I
    ...
    invoke-static {v2}, Lcom/android/settings/framework/util/log/dumper/HtcConfigurationDumper;->getDescriptionOfHasNavBar(I)Ljava/lang/String;
    ...
    iget v2, p3, Landroid/content/res/Configuration;->keyboard:I
    ...
    invoke-static {v2}, Lcom/android/settings/framework/util/log/dumper/HtcConfigurationDumper;->getDescriptionOfKeyboard(I)Ljava/lang/String;
    ...
    iget v2, p3, Landroid/content/res/Configuration;->keyboardHidden:I
    ...
    invoke-static {v2}, Lcom/android/settings/framework/util/log/dumper/HtcConfigurationDumper;->getDescriptionOfKeyboardHidden(I)Ljava/lang/String;
    ...
    iget-object v2, p3, Landroid/content/res/Configuration;->locale:Ljava/util/Locale;
    ...
    iget v2, p3, Landroid/content/res/Configuration;->mcc:I
    ...
    iget v2, p3, Landroid/content/res/Configuration;->mnc:I
    ...
    invoke-static {v2}, Lcom/android/settings/framework/util/log/dumper/HtcConfigurationDumper;->getDescriptionOfNavigation(I)Ljava/lang/String;
    ...
    iget v2, p3, Landroid/content/res/Configuration;->navigationHidden:I
    ...
    invoke-static {v2}, Lcom/android/settings/framework/util/log/dumper/HtcConfigurationDumper;->getDescriptionOfOrientation(I)Ljava/lang/String;
    ...
    iget-object v2, p3, Landroid/content/res/Configuration;->skin:Ljava/lang/String;
    ...
    iget v2, p3, Landroid/content/res/Configuration;->touchscreen:I
    ...
    invoke-static {v2}, Lcom/android/settings/framework/util/log/dumper/HtcConfigurationDumper;->getDescriptionOfTouchscreen(I)Ljava/lang/String;
    ...
    iget-boolean v2, p3, Landroid/content/res/Configuration;->userSetLocale:Z
    ...
    invoke-virtual {p3}, Landroid/content/res/Configuration;->toString()Ljava/lang/String;
