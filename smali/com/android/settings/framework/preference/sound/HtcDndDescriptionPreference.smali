...
.method protected getCustomTitle()Ljava/lang/CharSequence;
    ...
    .prologue
    .line 33
    invoke-virtual {p0}, Lcom/android/settings/framework/preference/sound/HtcDndDescriptionPreference;->getContext()Landroid/content/Context;
...
.method protected onCreatePreferenceView(Landroid/view/ViewGroup;)Lcom/android/settings/framework/preference/HtcAbsDescriptionPreference$PreferenceView;
    ...
    .line 46
    .local v2, pv:Lcom/android/settings/framework/preference/HtcAbsDescriptionPreference$PreferenceView;
    invoke-virtual {p0}, Lcom/android/settings/framework/preference/sound/HtcDndDescriptionPreference;->getContext()Landroid/content/Context;
    ...
    .line 49
    .local v1, margin:I
    invoke-virtual {v2}, Lcom/android/settings/framework/preference/HtcAbsDescriptionPreference$PreferenceView;->getPaddingLeft()I

    move-result v0

    .line 50
    .local v0, left:I
    invoke-virtual {v2}, Lcom/android/settings/framework/preference/HtcAbsDescriptionPreference$PreferenceView;->getPaddingRight()I

    move-result v3

    .line 52
    .local v3, right:I
    invoke-virtual {v2, v0, v1, v3, v1}, Lcom/android/settings/framework/preference/HtcAbsDescriptionPreference$PreferenceView;->setPadding(IIII)V
