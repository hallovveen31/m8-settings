...
.method protected onGetValueInBackground(Landroid/content/Context;)Ljava/lang/Boolean;
    ...
    .line 113
    .local v0, isBothLocationProvidersOff:Z
    :goto_0
    if-nez v0, :cond_2
    ...
    :goto_1
    invoke-virtual {p0, v3}, Lcom/android/settings/framework/preference/location/HtcUseLocationForGooglePreference;->setEnabledInForeground(Z)V
    ...
    .end local v0           #isBothLocationProvidersOff:Z
    :cond_1
    move v0, v5
    ...
    .restart local v0       #isBothLocationProvidersOff:Z
    :cond_2
    move v3, v5
